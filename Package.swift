...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMAShareUltralight",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMAShareUltralight/AMAShareUltralight-1.0.0-rc22.zip",
            checksum: "7013bcc473917f34cb73ea55b40b542a63d74bd5661cab1816270acc3883b3cd"
        ),
        .target(
