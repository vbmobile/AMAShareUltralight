...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AMAShareUltralight",
            url: "https://vbmobileidstorage.blob.core.windows.net/ios/AMAShareUltralight/AMAShareUltralight-3.0.0.zip",
            checksum: "1faaa4b47798b46d75226056d120cf87ad1140a3709dbffef3cdd511d686ff97"
        ),
        .target(
